        ...
        {items.map((item, idx) => (
          <li
            ...
            className='w-[90vw] max-w-full relative rounded-2xl border border-b-0
             flex-shrink-0 bg-[#FFFFFF] dark:bg-[rgb(4,7,29)] border-white-200 dark:border-slate-800 p-5 md:p-16 md:w-[60vw]'
            style={{
              //   background:
              //     "linear-gradient(180deg, var(--slate-800), var(--slate-900)", //remove this one
              //   add these two
              //   you can generate the color from here https://cssgradient.io/
              // background: `${isDarkMode ? 'rgb(4,7,29)' : '#FFFFFF'}`,
              backgroundColor: `${
                isDarkMode
                  ? 'linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,35,1) 100%)'
                  : 'linear-gradient(90deg, rgba(255, 245, 226, 1) 0%, rgba(255, 210, 132, 1) 100%)'
              }`,
            }}
            ...
            <blockquote>
              ...
              <div className='relative z-20 mt-6 flex flex-row items-center'>
                ...
                <span className='flex flex-col gap-1'>
                  ...
                  {/* change text color */}
                  <span className=' text-sm leading-[1.6] text-slate-800 dark:text-white-200 font-normal'>
                    {item.title}
                  </span>
                </span>
              </div>
